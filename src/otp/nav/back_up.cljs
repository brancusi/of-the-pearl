(ns otp.nav.back-up
  (:require [otp.hooks.use-hover-animations :refer [use-hover-animations]]
            [otp.hooks.use-media-query :refer [use-media-breakpoint]]
            [otp.hooks.use-scroll-threshold :refer [use-scroll-threshold]]
            [otp.hooks.use-scroll-to :refer [use-scroll-to-top]]
            [otp.hooks.use-toggle-animations :refer [use-toggle-animations]]
            [otp.utils.window :as win-utils]
            [otp.lib.defnc :refer [defnc]]
            [otp.ui.icons :refer [ArrowTurnRightUp]]
            [helix.core :refer [$]]
            [helix.dom :as d]
