...
(def site-map [{:id ::venue
                :path "visit"
                :title "Visit"
                :view (lazy-component otp.pages.venue.page/venue-view)}

               {:id ::artist
                :path "artist"
                :title "Artist"
                :view (lazy-component otp.pages.artist.page/artist-view)}

               {:id ::blog
                :path "blog"
                :title "Blog"
                :view (lazy-component otp.pages.blog.page/blog-view)}

               {:id ::press
                :path "press"
                :title "Press"
                :view (lazy-component otp.pages.press.page/press-view)}

               {:id ::budget
                :path "budget"
                :title "Budget"
                :view (lazy-component otp.pages.budget.page/budget-view)}

               {:id ::mockups
                :path "mockups"
                :title "Mockups"
                :hide-footer? true
                :view (lazy-component otp.pages.mockup.page/mockup-view)}])
...
(defn routes
  ...
  (into ["/"
         [""
          {:name :home
           :view (lazy-component otp.pages.landing.page/landing-view)
