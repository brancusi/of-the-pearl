(ns otp.pages.venue.page
  "Visitor Guide — wayfinding, venue history, and space details.
   Full dedicated page for the Armenia Pavilion location at the
   Venice Biennale 2026."
  (:require
   [otp.pages.venue.map-config :as mc]
   [otp.ui.map :refer [mapbox-map]]
   [otp.ui.image-gallery :refer [lazy-image-gallery]]
   [otp.ui.button :refer [main-button]]
   [otp.ui.page-shell :refer [page-shell]]
   [otp.ui.section-header :refer [section-eyebrow]]
   [otp.ui.icons :refer [MapPinIcon]]
...
(def lazy-video (lazy-component otp.ui.video-background/video-background))
