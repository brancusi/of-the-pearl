(ns otp.pages.mockup.page
  (:require
   [otp.pages.mockup.copy-link :refer [copy-link-button]]
   [otp.pages.mockup.footer :refer [mockup-footer]]
   [otp.pages.mockup.hud :refer [mockup-hud]]
   [otp.pages.mockup.objects :as objects]
   [otp.pages.mockup.parts-panel :refer [parts-panel]]
   [otp.pages.mockup.scene :as scene]
   [otp.pages.mockup.selection-info :refer [selection-info-bar]]
   [otp.pages.mockup.renderers.manual-formation :as mf]
   [otp.pages.mockup.renderers.simple-stack-formation :as ssf]
   [otp.hooks.use-atom-state :refer [use-atom-state]]
   [otp.lib.defnc :refer [defnc]]
   [otp.state.provider :refer [use-main-state]]
   [otp.services.firebase :refer [listen-to-edn]]
   [helix.core :refer [$]]
   [helix.dom :as d]
