(ns otp.pages.budget.table
  (:require
   [otp.ui.icons :refer [ChevronRightIcon InformationCircle]]
   [otp.lib.defnc :refer [defnc]]
   [otp.styles :as s]
   [helix.core :refer [$]]
   [otp.hooks.use-scroll-to :refer [use-scroll-to-ref]]
   [otp.utils.debug :refer [spy]]
   [helix.dom :as d]
